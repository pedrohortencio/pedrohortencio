...
> - :books: Since I had a class, at university, about Artificial Intelligence, I become fascinated about the field. Since then, I did a lot of other courses, specializations and projects. The specializations I enjoyed the most was:
>   - :bar_chart: Applied Data Science with Python
>   -  🧠 TensorFlow Developer
>   -  🧠 TensorFlow Data and Deployment
>   - :cloud: Cloud Architect with Google Cloud Platform
> - Currently, I am doing some projects, specially Kaggle's ones, to apply the knowledge of the courses I took.
>   - 🤺 The one that I'm more involved right now is a battle between different algorithms in some pretty classic datasets. I kindly named it [Machine Learning Gladiator](https://github.com/pedrohortencio/machine-learning-gladiator).
> - :dancers: I'm avaiable to join projects related with AI and/or DS. I'm also open to share my knowledge and learn something new!
> - :thought_balloon: I'm somewhat a reserved person. I don't really like to party, but I do like to talk about things that I find interesting.
> - :sparkles: There are a lot of things that I find interesting besides technology. There's a huge list of things I absolutely love, which includes dogs, cats, music, food and games. I tend to prefer cats and Pop/EDM music, but by a slim margin.
